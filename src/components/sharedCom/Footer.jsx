  ...
  return (
    <footer className="footer footer-center p-10 bg-gradient-to-b	from-blue-700 to-blue-500 text-base-content rounded">
      <nav className="grid grid-flow-col gap-4 text-slate-100 lg:text-lg text-base font-semibold">
        ...
        <Link to="/treatments" className="link link-hover">
          Treatments
        </Link>
      ...
      <nav>
        <div className="grid grid-flow-col gap-4 text-white ">
          ...
          <a
            href="https://www.youtube.com/watch?v=I6fKzygrgfE&ab_channel=HillsboroughCounty"
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            href="https://www.facebook.com/groups/2574169345979465"
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
